...
export const About = () => {
    ...
    return (
        <section className="background pt-10 pb-20 px-40">
            <h1 className='font-bold cream text-6xl 2xl:text-9xl playfair text-start'>About Us</h1>
            <div className="bg-cream self-center p-8 rounded-lg mt-4">
